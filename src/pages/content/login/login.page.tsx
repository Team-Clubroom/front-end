            ...
            <div className="flex w-full">
              <button type="submit" className={loginStyles.submitButton}>
                {isLoading ? (
                  ...
                  <div className={loginStyles.loadDiv}>
                    <span className={loginStyles.loading}>Signing In</span>
                    <svg aria-hidden="true" className={loginStyles.spinner} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
