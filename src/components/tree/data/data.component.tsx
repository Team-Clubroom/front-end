      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [{ name: "Gadget World Inc", establishmentDate: "1999-03-17" }, { name: "Tech Mart Ltd", establishmentDate: "1999-05-28" }],
          },
        ],
      },
      {
        ...
        children: [
          ...
          { name: "Insurance Group", establishmentDate: "2003-12-11", children: [{ name: "SecureShield Insurance Inc", establishmentDate: "2004-02-29" }, { name: "LifeCare Assurance Ltd", establishmentDate: "2004-04-15" }]},
          { name: "Investment Management", establishmentDate: "2006-10-08", children: [{ name: "ProfitGuard Investments Inc", establishmentDate: "2007-03-26" }, { name: "WealthFund Ltd", establishmentDate: "2007-06-09" }]},
        ],
      },
    ],
  };
