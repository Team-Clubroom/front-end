...
interface RequestButtonProps {
  ...
  success?: { text: string; isSuccessful: boolean };
}
...
export const RequestButtonComponent = ({
  ...
  const renderedButton = isLoading
    ? loadingCode
    : success?.isSuccessful
    ? confirmCode
    : defaultCode;

  const className = success?.isSuccessful
    ? dashboardRootStyles.confirmButton
    : dashboardRootStyles.submitButton;
