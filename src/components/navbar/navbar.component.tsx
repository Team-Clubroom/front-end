...
export const NavbarComponent = () => {
    ...
    const divStyle = {
        backgroundColor: `${isClicked ? myDivClicked : isHovered ? myDivHovered : myDivNormal}`,
            ...
            <form className={navbarStyles.searchForm}>
                <div className={navbarStyles.searchContainer}
                    ...
                    <div className={navbarStyles.searchIconContainer}>
                        <span className={`material-symbols-outlined ${navbarStyles.searchIcon}`}>
                            device_hub
                        </span>
                        <input type="text"
                               ...
                               placeholder="Search company name..." required/>
                    </div>

                </div>
                <button type="submit"
                        className={navbarStyles.searchButton} style={{border: 'none', borderRadius: '50%'}}>
                        <span className={`material-symbols-outlined ${navbarStyles.searchIcon}`}>
                            search
                        </span>
                    ...
                    {!isLoggedIn && (
                        <div className={navbarStyles.authButtons}>
                            <NavLink className={navbarStyles.authLink} to="/login">
                                <div className={navbarStyles.linkText}>
                                    Log In
                                </div>
                            </NavLink>
